...
class Market:
    ...
    def display_market(self, screen, clock):
        font = pygame.font.SysFont(["SimHei", "Arial Unicode MS", "NotoSansCJK", "MS Gothic"], 28)
        ...
        while running:
            ...
            positions = [(20, 20), (330, 20), (660, 20), (20, 200), (330, 200), (660, 200)]
